...
function register_user($username, $firstname, $lastname, $sex, $email, $password){
    global $connection;
        ...
        $query = "INSERT INTO users (username, user_firstname, user_lastname, user_sex, user_reg,user_birthday, user_email, user_password, user_role,user_lastlogin) VALUES ('{$username}','{$firstname}','{$lastname}','{$sex}', '{$reg_date}','{$reg_date}', '{$email}', '{$password}', 'subscriber','$reg_date')";
...
function login_user($username, $password){
    ...
    if (password_verify($password, $db_user_password)) {
        ...
        if(isset($_COOKIE["rdrctPath"])){
            redirect("/".$_COOKIE["rdrctPath"]);
            exit;
        }else{
        ...
        redirect("../login.php?header=Warrning&msg=Username or Password you entered is wrong");
    }
}
