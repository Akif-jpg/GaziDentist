        ...
        <div class="col-md-10">
            ...
            <?php
                if(isset($_SESSION['user_role']) && $_SESSION['user_role'] == 'admin'){
                    ...
                    $post_query_count = "SELECT Count(*) as count FROM posts WHERE `post_status` = 'publish'";
                }
                ...
                if($count < 1){
                    echo "<center><div class='alert alert-info'><strong>Üzgünüz!</strong> Erişilebilir Hiçbir Paylaşım Bulunamadı...</div></center>";
                }
                else {
                $count = ceil($count / 5);
